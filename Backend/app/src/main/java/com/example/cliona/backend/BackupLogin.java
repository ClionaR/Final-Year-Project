...
public class BackupLogin extends AppCompatActivity {
    ...
    String ServerLoginURL = "http://147.252.141.40:80/login.php";
    String finalResult ;
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(CheckEditText){
                    ...
                    Toast.makeText(BackupLogin.this, "Please fill all form fields.", Toast.LENGTH_LONG).show();
    ...
    public void LoginFunction(final String email, final String password){
        ...
        Toast.makeText(BackupLogin.this,"Button Clicked",Toast.LENGTH_SHORT).show();
        ...
        class LoginFunctionClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(BackupLogin.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if(httpResponseMsg.equalsIgnoreCase("Data Matched")){
                    ...
                    Intent intent = new Intent(BackupLogin.this, Profile.class);

                    startActivity(intent);
                }else{

                    Toast.makeText(BackupLogin.this,httpResponseMsg,Toast.LENGTH_LONG).show();
                }
            }
